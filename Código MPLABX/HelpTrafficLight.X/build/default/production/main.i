...
int main(int argc, char** argv){
    ...
    while(1){
        ...
        _delay((unsigned long)((20)*(80000000/4000.0)));
        if(PORTAbits.RA0 == 1){
            LATBbits.LB7 = 1;
...
# 92 "main.c"
        ...
        if(contador == 0){
            _delay((unsigned long)((7)*(80000000/4000.0)));
        }
        piractivar(0);
...
void delaymsled_red_green(void){
    _delay((unsigned long)((100)*(80000000/4000.0)));
}
void delaymsled_yellow(void){
    _delay((unsigned long)((30)*(80000000/4000.0)));
}
...
void piractivar(int flag){
    if (flag == 0){
        if (PORTDbits.RD2 == 1 && PORTAbits.RA0 == 1){
            PORTDbits.RD4 = 1;
        }
    }else{
        if (PORTDbits.RD0 == 1 && PORTDbits.RD4 == 1){
            PORTDbits.RD4 = 0;
            if(PORTAbits.RA0 == 1){
